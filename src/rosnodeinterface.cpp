...
//
// Code generated for Simulink model 'modechanger'.
//
// Model version                  : 6.3
// Simulink Coder version         : 9.8 (R2022b) 13-May-2022
// C/C++ source code generated on : Tue Nov 26 17:52:53 2024
//
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"modechanger\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(modechanger_M, (NULL));
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(modechanger_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(modechanger_M)
                == (NULL)) || rtmGetStopRequested(modechanger_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(modechanger_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
